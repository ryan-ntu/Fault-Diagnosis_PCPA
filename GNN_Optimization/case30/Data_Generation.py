...
import numpy as np
from pypower.api import ppoption, case30
import pandas as pd
import scipy.io
import copy
...
print(f'The length of V_H is {len(V_H)}, the length of E_H is {len(E_H)}')
...
scipy.io.savemat('./raw/data_case30.mat', data)
