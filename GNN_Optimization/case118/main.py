...
def build_model(model_name, N, E_H, V_H_zero, edge_index, device):
    ...
    if model_name == 'gat':
        ...
        return (
            ...
            f"model/case118_gat_baseline.pth",
            config
        )
        ...
        return (
            ...
            f"model/case118_gcn_baseline.pth",
            config
        )
        ...
        return (
            ...
            f"model/case118_cnn_transformer.pth",
            config
        )
    elif model_name == 'gae':
        config = {
...
def main():
    ...
    parser.add_argument("--lr_step_size", type=int, default=40)  # 学习率衰减步长
    parser.add_argument("--lr_gamma", type=float, default=0.5)   # 学习率衰减系数
    ...
    start_node = 20
    length_V_H = 20
    V_H = [int(v) for v in BFS_algorithm(mpc, start_node, length_V_H)]
